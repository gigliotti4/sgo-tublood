...
<template>
    <div :class="full ? 'sm:col-span-2' : ''">
        ...
        <textarea
            ...
            :rows="rows"
            v-bind="$attrs"
            class="w-full rounded-lg border bg-white px-4 py-2.5 text-[16px] text-gray-800 shadow-theme-xs transition placeholder:text-gray-400 focus:outline-none focus:ring-3 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 sm:text-sm"
            :class="error
