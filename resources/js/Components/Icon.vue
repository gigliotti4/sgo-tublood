...
/**
 * Íconos de Heroicons (24px, outline) como paths sueltos.
 *
 * Existe para que las páginas puedan usar íconos: los del menú están embebidos
 * en un objeto `icons` dentro de AppLayout.vue y no son accesibles desde afuera.
 * No hay superposición entre los dos conjuntos (allá son de navegación, acá de
 * acción), así que por ahora conviven; migrar AppLayout a este componente es un
 * refactor aparte.
 */
withDefaults(defineProps<{
    name: keyof typeof paths
    /** Trazo del SVG. Subirlo un poco ayuda en tamaños chicos. */
    stroke?: number
}>(), {
    stroke: 1.75,
})
