...
`users.view`, `users.create`, `users.edit`, `users.delete`, `roles.view`, `roles.create`, `roles.edit`, `roles.delete`, `permissions.view`, `clientes.view`, `clientes.sync`, `clientes.edit`, `clientes.vencimientos`, `observaciones.view`, `observaciones.edit`, `bitacora.view`
